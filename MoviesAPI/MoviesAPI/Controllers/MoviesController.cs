...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public async Task<ActionResult<MoviePutGetDTO>> PutGet(int id)
        {
            ...
            var movieTheaterSelectedIds = movie.MovieTheaters.Select(x => x.Id).ToList();
            var nonSelectedMovieTheaters = await context.MovieTheaters.Where(x => !movieTheaterSelectedIds.Contains(x.Id)).ToListAsync();
